...
const QUIZ = [
  ...
  },
  {
    ...
    multi: true,
    options: [
      { text: "টালিখাতা অ্যাপ থেকে আবেদন করে সবচেয়ে দ্রুত টালিপে বাংলা QR পাওয়া যায়।", correct: true },
...
function shareMessage() {
  return `টালিখাতা শেয়ার ক্যাম্পেইন\n` +
         `সহজ তিনটি প্রশ্নের উত্তর দিন আর রেফার করে জিতে নিন সর্বোচ্চ ১০,০০০ টাকা ক্যাশ পুরস্কার!*\n` +
         `এ সুযোগ সীমিত সময়ের জন্য। জলদি করুন।\n` +
         shareUrl();
}
